...
public:
	...
	static int CountOccurrencesInProcess(const char* pattern, const char* mask, DWORD processId, DWORD startAddress, DWORD endAddress);
	static int BuscarPatron(const char* pattern, const char* mask);
};
