...
class CNetworkHandler
{
	...
	HANDLE m_SeparatedTickAdrenaline;
...
public:
	...
	static void __cdecl SeparatedTickForAdre(void *args);
...
// static void __cdecl SecondAntibot2(void *args); //INSIDE CNetworkHandler CLASS
//static void __cdecl SecondAntibot(void *args); //INSIDE CNetworkHandler CLASS
