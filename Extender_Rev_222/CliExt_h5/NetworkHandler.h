...
public:
	...
	static void __cdecl SecondAntibot(void *args);
	static DWORD WINAPI AntibotThread(LPVOID lpParam);
	...
	static void __cdecl SecondAntibot2(void *args);
};
...
int CPHCheckAppsAsk(NHandler *pNetwork, CInPacket& packet);
