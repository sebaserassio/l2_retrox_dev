...
list<SkillPchId> g_OlympiadForbiddenSkillList; 
...
BOOL g_OlympiadEnterLast10Minute = TRUE;
BOOL g_OlympiadThirdClassSummons = FALSE;
...
BOOL g_OlympiadRestoreStatsOnFightStart = TRUE;

BOOL g_OlympiadSystemSecondTimeEnabled = FALSE;

INT32 OlympiadBufferNpcClassId;
...
{	
	...
	OlympiadBufferNpcClassId = GetPrivateProfileInt(section, _T("BufferClassId"), 0, g_ConfigFile);
	...
	g_OlympiadEnterLast10Minute = GetPrivateProfileInt(section, _T("OlympiadEnterLast10Minute"), 1, g_ConfigFile);
	g_OlympiadThirdClassSummons = GetPrivateProfileInt(section, _T("OlympiadThirdClassSummons"), 0, g_ConfigFile);
	...
	g_OlympiadRestoreStatsOnFightStart = GetPrivateProfileInt(section, _T("RestoreStatsOnFightStart"), 1, g_ConfigFile);

	g_OlympiadSystemSecondTimeEnabled = GetPrivateProfileInt(section, _T("OlympiadSystemSecondTimeEnabled"), 1, g_ConfigFile);
	...
	if(GetPrivateProfileString(section, _T("ForbiddenSkills"), 0, sTmp, 8192, g_ConfigFile))
	{
		wstringstream str;
		str << sTmp;
		int skillId = 0;
		while(str >> skillId)
		{
			SkillPchId skill(skillId);
			g_OlympiadForbiddenSkillList.push_back(skill);
		}
		if(g_OlympiadForbiddenSkillList.size() > 0)
		{
			g_OlympiadForbiddenSkillList.sort();
			g_OlympiadForbiddenSkillList.unique();
		}
	}
	...
	g_OlympiadPeriod[dayIndex][0].startHour2 = GetPrivateProfileInt(section, _T("SundayStart2"), 20, g_ConfigFile);
	g_OlympiadPeriod[dayIndex][0].endHour2 = GetPrivateProfileInt(section, _T("SundayEnd2"), 0, g_ConfigFile);
	...
	g_OlympiadPeriod[dayIndex][1].startHour2 = GetPrivateProfileInt(section, _T("SundayStartEx2"), 20, g_ConfigFile);
	g_OlympiadPeriod[dayIndex][1].endHour2 = GetPrivateProfileInt(section, _T("SundayEndEx2"), 0, g_ConfigFile);
	...
	g_OlympiadPeriod[dayIndex][0].startHour2 = GetPrivateProfileInt(section, _T("MondayStart2"), 20, g_ConfigFile);
	g_OlympiadPeriod[dayIndex][0].endHour2 = GetPrivateProfileInt(section, _T("MondayEnd2"), 0, g_ConfigFile);
	...
	g_OlympiadPeriod[dayIndex][1].startHour2 = GetPrivateProfileInt(section, _T("MondayStartEx2"), 20, g_ConfigFile);
	g_OlympiadPeriod[dayIndex][1].endHour2 = GetPrivateProfileInt(section, _T("MondayEndEx2"), 0, g_ConfigFile);
	...
	g_OlympiadPeriod[dayIndex][0].startHour2 = GetPrivateProfileInt(section, _T("TuesdayStart2"), 20, g_ConfigFile);
	g_OlympiadPeriod[dayIndex][0].endHour2 = GetPrivateProfileInt(section, _T("TuesdayEnd2"), 0, g_ConfigFile);
	...
	g_OlympiadPeriod[dayIndex][1].startHour2 = GetPrivateProfileInt(section, _T("TuesdayStartEx2"), 20, g_ConfigFile);
	g_OlympiadPeriod[dayIndex][1].endHour2 = GetPrivateProfileInt(section, _T("TuesdayEndEx2"), 0, g_ConfigFile);
	...
	g_OlympiadPeriod[dayIndex][0].startHour2 = GetPrivateProfileInt(section, _T("WednesdayStart2"), 20, g_ConfigFile);
	g_OlympiadPeriod[dayIndex][0].endHour2 = GetPrivateProfileInt(section, _T("WednesdayEnd2"), 0, g_ConfigFile);
	...
	g_OlympiadPeriod[dayIndex][1].startHour2 = GetPrivateProfileInt(section, _T("WednesdayStartEx2"), 20, g_ConfigFile);
	g_OlympiadPeriod[dayIndex][1].endHour2 = GetPrivateProfileInt(section, _T("WednesdayEndEx2"), 0, g_ConfigFile);
	...
	g_OlympiadPeriod[dayIndex][0].startHour2 = GetPrivateProfileInt(section, _T("ThursdayStart2"), 20, g_ConfigFile);
	g_OlympiadPeriod[dayIndex][0].endHour2 = GetPrivateProfileInt(section, _T("ThursdayEnd2"), 0, g_ConfigFile);
	...
	g_OlympiadPeriod[dayIndex][1].startHour2 = GetPrivateProfileInt(section, _T("ThursdayStartEx2"), 20, g_ConfigFile);
	g_OlympiadPeriod[dayIndex][1].endHour2 = GetPrivateProfileInt(section, _T("ThursdayEndEx2"), 0, g_ConfigFile);
	...
	g_OlympiadPeriod[dayIndex][0].startHour2 = GetPrivateProfileInt(section, _T("FridayStart2"), 20, g_ConfigFile);
	g_OlympiadPeriod[dayIndex][0].endHour2 = GetPrivateProfileInt(section, _T("FridayEnd2"), 0, g_ConfigFile);
	...
	g_OlympiadPeriod[dayIndex][1].startHour2 = GetPrivateProfileInt(section, _T("FridayStartEx2"), 20, g_ConfigFile);
	g_OlympiadPeriod[dayIndex][1].endHour2 = GetPrivateProfileInt(section, _T("FridayEndEx2"), 0, g_ConfigFile);
	...
	g_OlympiadPeriod[dayIndex][0].startHour2 = GetPrivateProfileInt(section, _T("SaturdayStart2"), 20, g_ConfigFile);
	g_OlympiadPeriod[dayIndex][0].endHour2 = GetPrivateProfileInt(section, _T("SaturdayEnd2"), 0, g_ConfigFile);
	...
	g_OlympiadPeriod[dayIndex][1].startHour2 = GetPrivateProfileInt(section, _T("SaturdayStartEx2"), 20, g_ConfigFile);
	g_OlympiadPeriod[dayIndex][1].endHour2 = GetPrivateProfileInt(section, _T("SaturdayEndEx2"), 0, g_ConfigFile);
...
void COlympiadSystem::Initialize()
{
	...
	if(g_OlympiadSystemEnabled)
	{
		...
		for(int n=0;n<7;n++)
		{
			...
			if(g_OlympiadSystemSecondTimeEnabled)
			{
				g_Log.Add(CLog::Blue, "[%s] Start Second[%d][%d] End Second[%d][%d] Day[%d]", __FUNCTION__, g_OlympiadPeriod[n][0].startHour2, g_OlympiadPeriod[n][1].startHour2, g_OlympiadPeriod[n][0].endHour2, g_OlympiadPeriod[n][1].endHour2, n);
			}
		}
		...
		g_HookManager.WriteCall(0x6FE549, COlympiadUser::SetPlayer2);
		g_HookManager.WriteCall(0x6FE59D, COlympiadUser::SetPlayer2);

	}
}

//COlympiadUser::SetPlayer
bool COlympiadUser::SetPlayer2(COlympiadUser* this_, BYTE byPlayerOrder, int nFieldId, FVector pos)
{
	bool ret = false;

	typedef bool (*SP)(COlympiadUser *pThis, BYTE PlayerOrder, int FieldId, FVector pFVector);
	SP xSP = (SP)(0x00707CB0L);
	ret = xSP(this_, byPlayerOrder, nFieldId, pos);

	if(ret)
	{
		if(OlympiadBufferNpcClassId)
		{
			map<wstring, wstring> aiParams;
			aiParams.insert(pair<wstring, wstring>(L"fnHi", L"buffer_npc_olys.htm"));
			NpcServer::SpawnNpcEx(OlympiadBufferNpcClassId, pos.x-30, pos.y-30, pos.z, aiParams);
		}
	}
...
float COlympiadSystem::ReturnDouble1(float val)
{
	return 1.0;
}
...
void COlympiadSystem::OnSaveOlympiadRecord(LPVOID lpInstance, UINT winnerId, UINT looserId, int winnerPoint, int looserPoint)
{
	...
	try
	{
		...
		if(User *pUser = g_UserDB.GetUserByDBID(winnerId))
		{
			...
			g_OlympiadStatus.m_LoadCustom = true;

			g_Achivments.SetUser_Olympiad(pUser);
...
void COlympiadSystem::ResetPoints(User *pUser)
{
//	if(pUser->pSD->nWaitingForMatch == 1)
//	{
		//do the job
		...
		if(COlympiadField *pOF = pUser->olympiadUser.GetField())
		{
			...
			if(pNI)
			{
				...
				pNI->nOlympiadPoints = 0;
				pNI->nOlympiadLoseCount = 0;
				pNI->nOlympiadMatchCount = 0;
				SaveOlympiadRecord(0, pUser->nDBID, 0, 0);
				g_Log.Add(CLog::Error, "[%s] User[%S] DBID[%d] Reset por cambio de clase [%d] points.", __FUNCTION__, pUser->pSD->wszName, pUser->nDBID, nPoints);
			}
		}
//	}
}
...
bool COlympiadSystem::GetWantedStatus(LPVOID pOlympiadSys, DWORD nSeasonStartTime, COlympiadStatus *pOS)
{
	...
	if(SSQPart::none == SSQSystem::GetInstance()->GetWinner())
	{
		...
		StartHour2 = g_OlympiadPeriod[ti.tm_wday][0].startHour2;
		EndHour2 = g_OlympiadPeriod[ti.tm_wday][0].endHour2;

	}else
	{
		StartHour = g_OlympiadPeriod[ti.tm_wday][1].startHour;
		EndHour = g_OlympiadPeriod[ti.tm_wday][1].endHour;
		StartHour2 = g_OlympiadPeriod[ti.tm_wday][1].startHour2;
		EndHour2 = g_OlympiadPeriod[ti.tm_wday][1].endHour2;
	}

	pOS->EnableMatches = true;

	if( g_OlympiadSystemSecondTimeEnabled == FALSE )
	{
...
bool COlympiadSystem::GetOlympiadStatus()
{
	tm ti;
	GetTimeInfo(ti);
...
void COlympiadDB::LoadForbiddenSkill()
{
	...
	wstring file = ReadFileW(g_ChangeFolders.Setting_txt);
	if(file.size() > 0)
	{
...
void COlympiadDB::LoadBuffSupport()
{
	LPBYTE lpFile = 0;
	m_BuffSupport.clear();
	UINT len = ReadFileBinary(g_ChangeFolders.OlympiadSupport_txt.c_str(), lpFile);
	if(lpFile)
	{
		if(len > 2)
		{
...
bool COlympiadDB::IsForbiddenSkill(int skillId, int level)
{
	...
	for(list<SkillPchId>::iterator Iter = g_OlympiadForbiddenSkillList.begin(); Iter!= g_OlympiadForbiddenSkillList.end();Iter++)
	{
		if((*Iter) == id)
		{
			return true;
