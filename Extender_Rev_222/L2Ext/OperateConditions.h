...
class CSkillOperateCondition_op_free_slots: public CSkillOperateCondition
{
	BOOL m_FreeSlots;
public:
	virtual bool CanUse(CCreature *pCreature, CObject *pTarget);
...
class CSkillOperateCondition_op_sweep_spoil: public CSkillOperateCondition
{
	BOOL m_FreeSlots;
public:
	virtual bool CanUse(CCreature *pCreature, CObject *pTarget);
...
class CSkillOperateCondition_op_remain_hp_diff: public CSkillOperateCondition
{
	int nDiff;
public:
	virtual bool CanUse(CCreature *pCreature, CObject *pTarget);
