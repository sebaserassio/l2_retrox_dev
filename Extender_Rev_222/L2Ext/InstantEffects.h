...
class CSkillEffect_i_report_bot : public CSkillEffect
{
public:
	virtual bool CalcSuccess(CCreature *pSkillUser, CCreature *pTarget, CSkillInfo *pSkillInfo, CSkillAction *pAction) { return false; };
	virtual void Instant(CCreature *pCreature, CCreature *pTarget, CSkillInfo *pSkillInfo, CSkillAction *pAction, double distance);
...
class CSkillEffect_i_cancel_min_max : public CSkillEffect
{
	double dType; // 0x10
	double dCount;
public:
...
class CSkillEffect_i_cancel_min_max_backup : public CSkillEffect
{
	double dType; // 0x10
	double dCount;
public:
...
class CSkillEffect_i_dispel_by_slot_probability_backup : public CSkillEffect
{
	double dAbnormal; // 0x10
	double dChance;
public:
	virtual bool CalcSuccess(CCreature *pCreature, CCreature *pTarget, CSkillInfo *pSkillInfo, CSkillAction *pAction) { return false; };
	virtual void Instant(CCreature *pSpeller, CCreature *pTarget, CSkillInfo *pSkillInfo, CSkillAction *pAction, double distance);
...
class CSkillEffect_i_dispel_by_category_rand : public CSkillEffect
{
	double dType; // 0x10
	double dCount;
public:
...
class CSkillEffect_i_dispel_by_category_rand50 : public CSkillEffect
{
	double dType; // 0x10
	double dCount;
public:
...
class CSkillEffect_i_spawn_aganthion : public CSkillEffect
{
	double dNpcID; // 0x10
	double dSkillId;
public:
...
class CSkillEffect_i_give_item_maxcount : public CSkillEffect
{
	double itemId; // 0x10
	double count;
public:
...
class CSkillEffect_i_sweep_consume_body : public CSkillEffect
{
public:
	virtual bool CalcSuccess(CCreature *pSkillUser, CCreature *pTarget, CSkillInfo *pSkillInfo, CSkillAction *pAction) { return false; };
	virtual void Instant(CCreature *pCreature, CCreature *pTarget, CSkillInfo *pSkillInfo, CSkillAction *pAction, double distance);
...
class CSkillEffect_i_dispel_skill_id : public CSkillEffect
{
	double m_skillId;
	double m_level;
public:
