...
public:
	...
	static void SendUseItem(CSocket* ,const char*format, ...);
	static void SendDamage(CSocket* ,const char *format, ...);
	static void SendDamage2(CSocket* ,const char *format, ...);
	User* GetUser(CSocket* pSocket);
};
