...
/* 00EC */ int nRideState;
  ...
  CSkillEffect *m_TickEffects;
  CSkillEffect *m_pConsumeEffect;
/* 0100 */ vector<CSkillEffect *> m_vPumpEffect;
/* 0120 */ vector<CSkillEffect *> m_vInstantEffects;
