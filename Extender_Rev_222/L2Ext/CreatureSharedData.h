...
public:
	...
	/* 01A0 */ int m_MovingStatus; // MSTE_MOVING = 0x0,  MSTE_NOT_MOVING = 0x1,
	/* 01A4 */ int nMoveType;
	/* 01A8 */ int nStopMode;
	/* 01AC */ int m_Environment;	//  ENV_GROUND = 0x0,  ENV_UNDERWATER = 0x1,  ENV_AIR = 0x2,  ENV_HOVER = 0x3,  ENV_MAX = 0x4,
	...
	/* 01D0 */ int nPkPardon;
	/* 01D4 */ int nKarma;
	/* 01D8 */ USHORT m_nSulffrageCount;
	/* 01DA */ SHORT m_nSulffrageUsedCount;
	/* 01DC */ int nEvalScore;
	...
	/* 0314 */ int _n314;
	/* 0318 */ int nPledgeID;
	/* 031C */ int m_nPledgeIndex;
	/* 0320 */ int nIsPledgeLeader;
	/* 0324 */ int nAllianceID;
	/* 0328 */ int m_nAllianceIndex;
	/* 032C */ int nPartyID;
	/* 0330 */ int m_nPartyIndex;
	/* 0334 */ int m_bPartyMaster;
	...
	/* 0350 */ int m_nPrivateStoreLimit;
	/* 0354 */ int m_nPrivateStoreBuyLimit;
	/* 0358 */ int m_nPrivateStoreRecipeType;
	...
	/* 04C8 */ double MaxMP;
	/* 04D0 */ double MaxCP; 
	/* 04D8 */ double m_dOrgHPRegen;
	/* 04E0 */ double m_dOrgMPRegen;
	/* 04E8 */ double m_dOrgCPRegen;// forgspeed ?
	/* 04F0 */ double hpRegen;
	/* 04F8 */ double mpRegen;
	/* 0500 */ double cpRegen;
	/* 0508 */ double m_nMoveTypeSpeed;
	/* 0510 */ double fSpeed;
	/* 0518 */ double fHit;
	/* 0520 */ double fAvoid;
	/* 0528 */ double _f528;
	...
	/* 0644 */ int m_nTwilightItemCount[3];
	/* 0650 */ int m_nDawnItemCount[3];
	/* 065C */ int m_nTicketBuyCount;
	/* 0644 */ //int _n644;
	/* 0648 */ //int _n648;
	/* 064C */ //int _n64C;
	/* 0650 */ //int _n650;
	...
	/* 073C */ int _n073C;
	/* 0740 */ int _n0740;
	/* 0744 */ int m_nAgroRange;
	/* 0748 */ int _n0748;
	/* 074C */ int _n074C;
	/* 0750 */ int _n0750;
	/* 0754 */ int _n0754;
	/* 0758 */ int nSafeHeight;
	/* 075C */ int _n075C;
	/* 0760 */ int _n0760;
	...
	/* 090A */ short w90A;
	/* 090C */ int n90C;
	/* 0910 */ int AbnormalTable[60][2]; //AbnormalType, Level
