...
public:
	...
	static bool ValidateBuilderAccount(int accountId);
	static bool AdminBlockSummonItems(int itemid);
	static void LoadBlockSummonItemsIds();
	...
	static bool Handle2(User *pUser, wstring wsBuff);
	static bool SendCommandOffline(wstring wsBuff);
	static bool Faction(User *pUser, wstring wsParams);
	...
	static bool GiveSkillToAll(User *pUser, std::wstring wsParams);
	static bool JailPlayer(User *pUser, wstring wsParams);
	static bool EnchantWeapon(User *pUser, wstring wsParams);
	static bool EnchantSlot(User *pUser, wstring wsParams);
	static bool GiveItem(User *pUser, wstring wsParams);
	static bool GiveItem2(User *pUser, std::wstring wsParams);
	static bool DoCaptcha(User *pUser, wstring wsParams);
	static bool DoCaptcha2(User *pUser, wstring wsParams);
	...
	static bool SetHide(User* pUser, wstring wParams);
	static bool SetUnHide(User* pUser, wstring wParams);
	...
	static bool GiveItemInRange2(User *pUser, wstring wParams);

	static bool Recall2(User *pUser, std::wstring wsParams);
	static bool GetUserApps(User *pUser, std::wstring wsParams);


	static bool RegisterPlayerTvT(User *pUser, wstring wsParams);
	static bool UnRegisterPlayerTvT(User *pUser, wstring wsParams);

	static bool recall(User *pUser, wstring wsParams);

	static bool Summon(User *pUser, wstring wsParams);
	static bool Summon2(User *pUser, wstring wsParams);
