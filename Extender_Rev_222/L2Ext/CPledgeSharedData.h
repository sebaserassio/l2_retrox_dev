...
public:
	...
	/* 00CE */ WORD _unk00CE;
	/* 00D0 */ int _unk00D0;
	/* 00D4 */ int m_nOustTime;
	/* 00D8 */ int _unk00D8;
	/* 00DC */ int nActiveLevel;
	/* 00E0 */ int nAllyID;
	/* 00E4 */ int nLevel;
	/* 00E8 */ int nCrestID;
	/* 00EC */ int m_nEmblemId;
	/* 00F0 */ int _n00F0;
	/* 00F4 */ int _n00F4;
	...
	/* 0108 */ int nAgitID;
	/* 010C */ int _unk010C;
	/* 0110 */ int m_nFortressUnderOffenceSiegeId;
	/* 0114 */ int m_nFortressUnderDefenceSiegeId;
	/* 0118 */ int nMemberCount;
	/* 011C */ int m_OnlineMaster_id;
	/* 0120 */ int m_OnlineMaster_index;
