...
BOOL g_TradeAugmentItems = FALSE;
...
{	
	...
	g_TradeAugmentItems = GetPrivateProfileInt(_T("Features"), _T("TradeAugmentItems"), 0, g_ConfigFile);
	...
	if(true)
	{
		...
		ClanInfo.SetPenalty(CASTLE_ANNOUNCE_TIME, GetPrivateProfileInt(_T("ClanSystem"), _T("CASTLE_ANNOUNCE_TIME"), 86400, g_ConfigFile));
		ClanInfo.SetPenalty(CASTLE_STANDBY_TIME, GetPrivateProfileInt(_T("ClanSystem"), _T("CASTLE_STANDBY_TIME"), 86400, g_ConfigFile));


		ClanInfo.SetPenalty(PLEDGE_RECHALLENGE_PENALTY_TIMEOUT, GetPrivateProfileInt(_T("ClanSystem"), _T("PLEDGE_RECHALLENGE_PENALTY_TIMEOUT"), 432000, g_ConfigFile));
		ClanInfo.SetPenalty(PLEDGE_RECHALLENGE_DESPITE_REJECTION_PENALTY_TIMEOUT, GetPrivateProfileInt(_T("ClanSystem"), _T("PLEDGE_RECHALLENGE_DESPITE_REJECTION_PENALTY_TIMEOUT"), 432000, g_ConfigFile));
		ClanInfo.SetPenalty(ALLIANCE_RECHALLENGE_PENALTY_TIMEOUT, GetPrivateProfileInt(_T("ClanSystem"), _T("ALLIANCE_RECHALLENGE_PENALTY_TIMEOUT"), 432000, g_ConfigFile));
		ClanInfo.SetPenalty(ALLIANCE_RECHALLENGE_DESPITE_REJECTION_PENALTY_TIMEOUT, GetPrivateProfileInt(_T("ClanSystem"), _T("ALLIANCE_RECHALLENGE_DESPITE_REJECTION_PENALTY_TIMEOUT"), 432000, g_ConfigFile));
