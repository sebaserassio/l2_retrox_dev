...
public:
	...
	/* 500 */ int _n500[34];
			 // int _n528[28];			//ESTO CUANDO TENGA TIEMPO DEBERIA PROBARLO, SE SUPONE QUE ESTA BIEN, PERO NO PUEDO ARRIESGRA DE PROBARLO
			 // bool m_bDietMode;		//EN OFICIAL, PRIMERO TENGO QUE MEDIR LA ESTRUCTURA PARA SABER SI NO SE PASA DE TAMAÑO
			 // bool m_aaaa1;
			 // bool m_aaaa2;
			 // bool m_aaaa3;
			 // int _n500[5];
	...
	/* 980 */ int m_nTransferDamageRatio;
			  int xxxxasx;
	/* 988 */ double _dUnkn988[4];
	/* 9A8 */ int avoidAgro;
	/* 9AC */ int _nUnkn9AC;
	...
	/* A60 */ double m_dPvpPhysicalAttackBonusPer;
	/* A68 */ double pvp_physical_skill_dmg_bonus;
	/* A70 */ double pvp_magical_skill_dmg_bonus;
	/* A78 */ bool shieldDefenseAngle;
	/* A79 */ bool focusAttackPole;
	/* A7A */ bool m_bAbnormalLimit;
	...
	/* ACC */ int ES_Inventory_Normal;  // CSkillEffect_p_enlarge_storage::Pump
	/* AD0 */ int ES_Storage_Private;
	/* AD4 */ int ES_Trade;
	/* AD8 */ int ES_Sell;
	/* ADC */ int ES_Buy;
	/* AE0 */ int ES_Recipe_Dwarven;
	/* AE4 */ int ES_Recipe_Common;
...
public:
	...
	void AddItemToInventory(int itemId, int amount, bool isPick = false, int enchanted = 0, int blessed = 0, int eroded = 0, UINT augmentation = 0);
