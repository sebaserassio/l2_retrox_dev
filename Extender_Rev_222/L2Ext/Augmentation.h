...
public:
	...
	int nAugmentID;
	int nItemID;
	AugmentGoldSkill(){memset(this, 0, sizeof(AugmentGoldSkill));};
};*/

struct AugmentGoldSkill
{
	int nSkillID;
	int nLevel;
	int nAugmentID;
...
//typedef map<UINT , AugmentGoldSkill> AugmentGoldSkillMap;
...
class CAugmentation
{
	AugmentGoldSkill m_EmptyAugment;
	vector<AugmentGoldSkill> m_GoldAugment;
...
private:
	...
	//AugmentGoldSkillMap mSkillsGold;
...
public:
	...
	UINT GenerateAugmentation(int nLifeStoneGrade, int nLifeStoneLevel, int nItemID);
