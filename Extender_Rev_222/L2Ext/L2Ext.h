...
public:
	...
	static void ReloadEnterworldHtml();
	static void EtcHook();
	static bool ValidateAddress(INT64 nAddress, int nLen);

//	static FILE* DecryptFiles(char*, int var1, int var2);
	//static FILE* DecryptFiles(const char*, const char *var1, int var2);
	static char * L2Ext::DecryptFiles(const char *filename, __int64 var2);
