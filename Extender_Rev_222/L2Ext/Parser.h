...
public:
	...
	static wstring Trim2(wstring str);
	static string Trim(string str);
	static int ContarCaracteres(wstring str, wstring caracter);
	static int BuscarCoincidencias(wstring str, wstring caracteres);
	static wstring GetBypassValue(wstring wBypass, wstring wSub);
	static wstring GetBypassValueConEspacios(wstring wBypass, wstring wSub);
...
namespace Parser
{
	...
	wstring ParseOptionStringConEspacios(wstring line, wstring option, wstring sDefault = L"");
};