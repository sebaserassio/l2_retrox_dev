...
class CSkillEffect_p_pvp_physical_skill_dmg_bonus_by_weapon : public CSkillEffect
{
	bool baWeaponType[11]; //0x10h 
	unsigned char ucaUnkn[5];
	double DamageAmount; //0x20h
...
class CSkillEffect_p_defence_attribute_by_class : public CSkillEffect
{
	double value;	//10
	int attribute; //18h
public:
...
class CSkillEffect_p_frenzy_activo : public CSkillEffect
{
public:
	virtual bool CalcSuccess(CCreature *pCreature, CCreature *pTarget, CSkillInfo *pSI, CSkillAction* pAction) { return false; };
	virtual void Instant(CCreature *pCreature, CCreature *pTarget, CSkillInfo *pSI, CSkillAction* pAction, double distance) {};
...
class CSkillEffect_p_stop_exp : public CSkillEffect
{
public:
	virtual bool CalcSuccess(CCreature *pCreature, CCreature *pTarget, CSkillInfo *pSI, CSkillAction* pAction) { return false; };
	virtual void Instant(CCreature *pCreature, CCreature *pTarget, CSkillInfo *pSI, CSkillAction* pAction, double distance) {};
...
class CSkillEffect_p_global_shout : public CSkillEffect
{
public:
	virtual bool CalcSuccess(CCreature *pCreature, CCreature *pTarget, CSkillInfo *pSI, CSkillAction* pAction) { return false; };
	virtual void Instant(CCreature *pCreature, CCreature *pTarget, CSkillInfo *pSI, CSkillAction* pAction, double distance) {};
...
class CSkillEffect_p_custom_conversion : public CSkillEffect
{
	double dPercent;
public:
	virtual bool CalcSuccess(CCreature *pCreature, CCreature *pTarget, CSkillInfo *pSI, CSkillAction* pAction) { return false; };
...
class CSkillEffect_p_unequip_item : public CSkillEffect
{
	double itemId;
public:
	virtual bool CalcSuccess(CCreature *pCreature, CCreature *pTarget, CSkillInfo *pSI, CSkillAction* pAction) { return false; };
