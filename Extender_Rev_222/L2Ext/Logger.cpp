...
void CLogger::GenerateFileName(PWCHAR sFile, PWCHAR sDirectory, const WCHAR* wFileBase)
{
	...
	if(wFileBase)
	{
		swprintf_s(sFile, 255, L"%s/%0.4d-%0.2d-%0.2d-%0.2d-%0.2d-%s.txt", sDirectory, (timeinfo.tm_year+1900), (timeinfo.tm_mon+1), timeinfo.tm_mday, timeinfo.tm_hour, timeinfo.tm_min, wFileBase);
	}else
	{
		swprintf_s(sFile, 255, L"%s/%0.4d-%0.2d-%0.2d-%0.2d-%0.2d.txt", sDirectory, (timeinfo.tm_year+1900), (timeinfo.tm_mon+1), timeinfo.tm_mday, timeinfo.tm_hour, timeinfo.tm_min);
	}
}
