...
//	pUser->GetSocket()->Send("cdSddb", 0x87, 19, L"Engine.dll", 0x134520, 1, 1, 0x28);			//Engine.dll+134520	NO MOSTRAR ARGUS EN USERINFO		para el arma en otra mano, jamas se usa seria tambien en +134574
//	pUser->GetSocket()->Send("cdSddb", 0x87, 19, L"Engine.dll", 0x134520, 1, 1, 0x24);			//Engine.dll+134520	MOSTRAR ARGUS EN USERINFO		//ORIGINAL

//	pUser->GetSocket()->Send("cdSddb", 0x87, 19, L"Engine.dll", 0x1368f3, 1, 1, 0x24);			//Engine.dll+1368f3	NO MOSTRAR ARGUS EN CHARINFO
//	pUser->GetSocket()->Send("cdSddb", 0x87, 19, L"Engine.dll", 0x134520, 1, 1, 0x20);			//Engine.dll+1368f3	MOSTRAR ARGUS EN CHARINFO		//ORIGINAL

	//Engine.dll+3c0127					para quitar glow de Hero a las armas y que se puedan ver los enchant 2 0x90


//Engine.dll+1b98d8			quitar aura hero de las armas

int g_PrivateStore_ItemId = 57;
...
BOOL g_MiAutoSkillAprenderSinItems = 0;
...
BOOL g_Servidor_beta_multisell_free = FALSE;
...
double g_CastingLimitMls = 500.0;
...
INT32 g_ChangeChatVip_ItemId = 0;
INT32 g_ChangeChatVip_ItemCount = 0;
...
INT32 g_ChangeName_ItemId = 0;
INT32 g_ChangeName_ItemCount = 0;
...
extern IVector posTeleportZone[10];
...
double g_EnchantMatkModify = 2.0;
double g_EnchantPatkModify = 2.0;
...
double g_DamagePlayerMultiplerWarriorAMago_none = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_sword = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_blunt = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_dagger = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_pole = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_fist = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_bow = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_etc = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_dual = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_dualfist = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_fishing_rod = 1.0;

double g_DamagePlayerMultiplerWarriorAMago_noneTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_swordTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_bluntTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_daggerTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_poleTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_fistTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_bowTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_etcTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_dualTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_dualfistTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAMago_fishing_rodTwo = 1.0;

double g_DamagePlayerMultiplerWarriorAWarrior_none = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_sword = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_blunt = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_dagger = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_pole = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_fist = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_bow = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_etc = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_dual = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_dualfist = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_fishing_rod = 1.0;

double g_DamagePlayerMultiplerWarriorAWarrior_noneTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_swordTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_bluntTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_daggerTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_poleTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_fistTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_bowTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_etcTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_dualTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_dualfistTwo = 1.0;
double g_DamagePlayerMultiplerWarriorAWarrior_fishing_rodTwo = 1.0;

INT32 g_reuseDelayBOW = 1500;


bool g_verificarSiTienenDestroOPala;
int g_pasiva_mago_no_pala_destro;
int g_pasiva_mago_no_pala;
int g_pasiva_mago_no_destro;

int g_pasiva_warrior_no_pala_destro;
int g_pasiva_warrior_no_pala;
int g_pasiva_warrior_no_destro;



double g_MagoVsMago = 1.0;
double g_MagoVsWarrior = 1.0;
double g_WarriorVsMago = 1.0;
double g_WarriorVsWarrior = 1.0;

double g_DamageWarriorsAWarriorMinimo = 999999.0;
double g_DamageWarriorsAWarriorMaximo = 999999.0;

double g_DamageWarriorsAMagoMinimo = 999999.0;
double g_DamageWarriorsAMagoMaximo = 999999.0;
...
BOOL g_ZonePvPSpawnBossBarakiel = false;
...
extern std::vector<MemoryChangeData> m_MemoryChangeData;
...
INT32 g_DropSpoilEnchantArmorMaxTimeMinutes = 0;
INT32 g_DropSpoilEnchantWeaponMaxTimeMinutes = 0;
INT32 g_DropSpoilEnchantArmorMaxCount = 0;
INT32 g_DropSpoilEnchantWeaponMaxCount = 0;
INT32 g_DropSpoilEnchantArmorContadorDrop = 0;
INT32 g_DropSpoilEnchantWeaponContadorDrop = 0;



int g_kBatchTitle = 1000;
...
void NuevasFunciones::Init()
{
	...
	//g_HookManager.WriteMemoryBYTES(0x6AD99E, "E9 BE 0A 00 00 90");		//Use PathNode IsUser L2OFF C4 Files
	//g_HookManager.WriteMemoryBYTES(0x786532, "E9 6C 03 00 00 90");		//Use PathNode IsUser L2OFF H5 Files
	...
	g_HookManager.NopMemory(0x62621D, 5);		//no mostrar mensaje dwtime < 80
	...
	//BYTE movrcxr12[8] = {0x49, 0x8B, 0xCC, 0x90, 0x90, 0x90, 0x90, 0x90};
	//WriteProcessMemory(hL2Server,(LPVOID)0x450A63, &movrcxr12, 8, &bw);
	//ARREGLAR TAMAÑO DEL //ANNOUNCE
	//g_HookManager.WriteMemoryBYTES(0x450416, "49 8B CC 90 90 90 90 90");


//            CSocket::Send(v24->data.pSocket, "cddddd", 100i64, 48i64, v161, 3, v21);
	//NO MOSTRAR MENSAJE DE NO SE PUEDE USAR EL ITEM POR EL REUSE TIME, PARA EVITAR EL SPAM DE CHAT CUANDO USAN AUTOPOTAS
	g_HookManager.NopMemory(0x4F9F7D, 5);


	g_HookManager.WriteRelativeAddress(0x6B60D0, 4, &g_CastingLimitMls, 0);	//CSkillEffect_i_hp_drain::Instant()



	g_HookManager.WriteCall(0x6A1F52, NuevasFunciones::CheckBowCondition, 0);




//	g_HookManager.WriteCall(0x840F57, NuevasFunciones::User_SendInSight, 0);	
//	g_HookManager.WriteCall(0x84162C, NuevasFunciones::User_SendInSight, 0);
//	g_HookManager.NopMemory(0x61E18B, 4);
...
void NuevasFunciones::VerificarEstructuras()
{

	g_Log.Add(CLog::Error, "Struct User               : size[%p]=[0x2D80] | pUser->nObservationTime  [%p]=[0x2D70] ", sizeof(User), offsetof(User, User::language));
	g_Log.Add(CLog::Error, "Struct CCreature          : size[%p]=[0x1500] | CCreature::_unkn14F8     [%p]=[0x14F8] ", sizeof(CCreature), offsetof(CCreature, CCreature::_unkn14F8));
	g_Log.Add(CLog::Error, "Struct CNPC               : size[%p]=[0x19D8] | CNPC::pND                [%p]=[0x19D0] ", sizeof(CNPC), offsetof(CNPC, CNPC::pND));

	g_Log.Add(CLog::Error, "Struct CreatureSharedData : size[%p]=[0x0C0C] | SharedData::notUserdC08  [%p]=[0x0C08] ", sizeof(CreatureSharedData), offsetof(CreatureSharedData, CreatureSharedData::notUserdC08));

//	g_Log.Add(CLog::Error, "Struct COlympiadUser      : size[%p]=[0x0060] | SharedData::m_pUser      [%p]=[0x0058] ", sizeof(COlympiadUser), offsetof(COlympiadUser, COlympiadUser::m_pUser));

	g_Log.Add(CLog::Error, "Struct CUserSocket        : size[%p]=[0x0480] | CUserSocket::pED         [%p]=[0x0478] ", sizeof(CUserSocket), offsetof(CUserSocket, CUserSocket::pED));

	g_Log.Add(CLog::Error, "Struct CParty             : size[%p]=[0x0080] | CParty::itemRoutingType  [%p]=[0x0078] ", sizeof(CParty), offsetof(CParty, CParty::itemRoutingType));




  //  int charId = 6;
  //  std::wstring newCharName = L"rrrrrrrr2";

  //  NuevasFunciones::setCharacterName(charId, newCharName);
...
void NuevasFunciones::LoadINI()
{
	...
	g_MaxDeBuffLimit = GetPrivateProfileInt(_T("SkillFactory"), _T("MaxDeBuffLimit"), 10, g_ConfigFile);
	...
	//Reset agit Owner Automatic
	if(GetPrivateProfileInt(_T("AGIT"), _T("AutoReset"), FALSE, g_CustomConfigFile))
	{
		g_HookManager.NopMemory(0x43B9F8, 6);
	}

	int daysAuctionEnd = GetPrivateProfileInt(_T("AGIT"), _T("DaysAuctionEnd"), 7, g_CustomConfigFile);
	g_HookManager.WriteMemoryDWORD(0x43A92D, daysAuctionEnd);
	g_HookManager.WriteMemoryDWORD(0x43A9B1, daysAuctionEnd);
...
//	g_HookManager.WriteMemoryDWORD(0x6ECE4A+3, (DWORD)&gk_teleport_string_03);
	...
	g_MiAutoSkillAprenderSinItems = GetPrivateProfileInt(_T("AUTOSKILL"), _T("AprenderSinItems"), 0, g_CustomConfigFile);
	//----------------------------------------

	g_ZonePvPSpawnBossRadio = GetPrivateProfileInt(_T("NPC"), _T("ZonePvPSpawnBossRadio"), 0, g_CustomConfigFile);
	g_ZonePvPSpawnBossBarakiel = GetPrivateProfileInt(_T("NPC"), _T("ZonePvPSpawnBossBarakiel"), 0, g_CustomConfigFile);
...
//		g_HookManager.WriteMemoryBYTES(0x6FE4A2, "8C");		//cambio a condicionde JNZ por (GL)MENOR QUE para comparar si la class es menor que la minima tercera
	...
	BYTE g_DropCantidad = GetPrivateProfileInt(_T("DROP_PK"), _T("Cantidad"), 5, g_CustomConfigFile);
	g_HookManager.WriteMemoryBYTE2(0x0081C4E4, g_DropCantidad);		//CANTIDAD MAXIMA DE DROP CUANDO MUERE UN PJ POR ESTAR PK O POR MORIR CON UN BICHO
	...
	g_Servidor_beta_multisell_free  = GetPrivateProfileInt(_T("SERVER_BETA"), _T("MultisellGratis"), 0, g_CustomConfigFile);
	...
	g_CastingLimitMls = GetPrivateProfileDouble(_T("SKILLS"), _T("CastingLimitMls"), 500.0, g_CustomConfigFile);


	//DitanceToTargetMove----------------[DYES]----
	BOOL g_QuitarLimiteAtkSpeedBOW = GetPrivateProfileInt(_T("SKILLS"), _T("QuitarLimiteAtkSpeedBOW"), FALSE, g_CustomConfigFile);
	if (g_QuitarLimiteAtkSpeedBOW)
		g_HookManager.WriteMemoryBYTES(0x0069A4F6, "E9 E8 00 00 00 90");
	else
		g_HookManager.WriteMemoryBYTES(0x0069A4F6, "0F 84 E7 00 00 00");


	g_reuseDelayBOW = GetPrivateProfileInt(_T("SKILLS"), _T("reuseDelayBOW"), 1500, g_CustomConfigFile);
	...
	if(GetPrivateProfileInt(_T("SKILLS"), _T("CurarConCelestialShiel"), 0, g_CustomConfigFile))
	{
		g_HookManager.WriteMemoryBYTES(0x007A80B5,"EB");
		g_HookManager.WriteMemoryBYTES(0x007AA84E,"EB");
		g_HookManager.WriteMemoryBYTES(0x007B3860,"EB");
	}
	else
	{
		g_HookManager.WriteMemoryBYTES(0x007A80B5,"75");		//ORIGINAL
		g_HookManager.WriteMemoryBYTES(0x007AA84E,"75");		//ORIGINAL
		g_HookManager.WriteMemoryBYTES(0x007B3860,"75");
	}
	...
	g_MagoVsMago = GetPrivateProfileDouble(_T("BALANCED"), _T("MagoVsMago"), 1.0, g_CustomConfigFile);
	g_MagoVsWarrior = GetPrivateProfileDouble(_T("BALANCED"), _T("MagoVsWarrior"), 1.0, g_CustomConfigFile);

	g_WarriorVsMago = GetPrivateProfileDouble(_T("BALANCED"), _T("WarriorVsMago"), 1.0, g_CustomConfigFile);
	g_WarriorVsWarrior = GetPrivateProfileDouble(_T("BALANCED"), _T("WarriorVsWarrior"), 1.0, g_CustomConfigFile);


	g_DamageWarriorsAWarriorMinimo = GetPrivateProfileDouble(_T("BALANCED"), _T("DamageWarriorsAWarriorMinimo"), 9999999.0, g_CustomConfigFile);
	g_DamageWarriorsAWarriorMaximo = GetPrivateProfileDouble(_T("BALANCED"), _T("DamageWarriorsAWarriorMaximo"), 9999999.0, g_CustomConfigFile);

	g_DamageWarriorsAMagoMinimo = GetPrivateProfileDouble(_T("BALANCED"), _T("DamageWarriorsAMagoMinimo"), 9999999.0, g_CustomConfigFile);
	g_DamageWarriorsAMagoMaximo = GetPrivateProfileDouble(_T("BALANCED"), _T("DamageWarriorsAMagoMaximo"), 9999999.0, g_CustomConfigFile);

	g_verificarSiTienenDestroOPala = GetPrivateProfileInt(_T("BALANCED"), _T("VerificarSiTieneDestroPala"), 0, g_CustomConfigFile);
	g_pasiva_mago_no_pala_destro = GetPrivateProfileInt(_T("BALANCED"), _T("pasiva_mago_no_pala_destro"), 0, g_CustomConfigFile);
	g_pasiva_mago_no_pala = GetPrivateProfileInt(_T("BALANCED"), _T("pasiva_mago_no_pala"), 0, g_CustomConfigFile);
	g_pasiva_mago_no_destro = GetPrivateProfileInt(_T("BALANCED"), _T("pasiva_mago_no_destro"), 0, g_CustomConfigFile);

	g_pasiva_warrior_no_pala_destro = GetPrivateProfileInt(_T("BALANCED"), _T("pasiva_warrior_no_pala_destro"), 0, g_CustomConfigFile);
	g_pasiva_warrior_no_pala = GetPrivateProfileInt(_T("BALANCED"), _T("pasiva_warrior_no_pala"), 0, g_CustomConfigFile);
	g_pasiva_warrior_no_destro = GetPrivateProfileInt(_T("BALANCED"), _T("pasiva_warrior_no_destro"), 0, g_CustomConfigFile);
	...
	g_DropSpoilEnchantArmorMaxTimeMinutes = GetPrivateProfileInt(_T("SPOIL_ENCHANTS"), _T("EnchantArmorMaxTimeMinutes"), 0, g_CustomConfigFile);
	g_DropSpoilEnchantWeaponMaxTimeMinutes = GetPrivateProfileInt(_T("SPOIL_ENCHANTS"), _T("EnchantWeaponMaxTimeMinutes"), 0, g_CustomConfigFile);
	g_DropSpoilEnchantArmorMaxCount = GetPrivateProfileInt(_T("SPOIL_ENCHANTS"), _T("EnchantArmorMaxCount"), 0, g_CustomConfigFile);
	g_DropSpoilEnchantWeaponMaxCount = GetPrivateProfileInt(_T("SPOIL_ENCHANTS"), _T("EnchantWeaponMaxCount"), 0, g_CustomConfigFile);
...
g_DamagePlayerMultiplerWarriorAMago_none = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_none"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_sword = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_sword"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_blunt = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_blunt"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_dagger = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_dagger"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_pole = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_pole"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_fist = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_fist"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_bow = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_bow"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_etc = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_etc"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_dual = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_dual"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_dualfist = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_dualfist"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_fishing_rod = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_fishing_rod"), 1.0, g_CustomConfigFile);

g_DamagePlayerMultiplerWarriorAMago_noneTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_noneTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_swordTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_swordTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_bluntTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_bluntTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_daggerTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_daggerTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_poleTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_poleTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_fistTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_fistTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_bowTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_bowTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_etcTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_etcTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_dualTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_dualTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_dualfistTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_dualfistTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAMago_fishing_rodTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAMago_fishing_rodTwo"), 1.0, g_CustomConfigFile);

g_DamagePlayerMultiplerWarriorAWarrior_none = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_none"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_sword = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_sword"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_blunt = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_blunt"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_dagger = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_dagger"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_pole = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_pole"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_fist = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_fist"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_bow = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_bow"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_etc = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_etc"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_dual = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_dual"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_dualfist = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_dualfist"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_fishing_rod = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_fishing_rod"), 1.0, g_CustomConfigFile);

g_DamagePlayerMultiplerWarriorAWarrior_noneTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_noneTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_swordTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_swordTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_bluntTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_bluntTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_daggerTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_daggerTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_poleTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_poleTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_fistTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_fistTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_bowTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_bowTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_etcTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_etcTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_dualTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_dualTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_dualfistTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_dualfistTwo"), 1.0, g_CustomConfigFile);
g_DamagePlayerMultiplerWarriorAWarrior_fishing_rodTwo = GetPrivateProfileDouble(_T("DANIO_GENERAL"), _T("DamagePlayerMultiplerWarriorAWarrior_fishing_rodTwo"), 1.0, g_CustomConfigFile);



	g_PrivateStore_ItemId = GetPrivateProfileInt(_T("L2SERVER"), _T("PrivateStore_ItemId"), 57, g_CustomConfigFile);
	...
	g_kBatchTitle = GetPrivateProfileInt(_T("TVT"), _T("kBatchTitle"), 1000, g_CustomConfigFile);
	...
	g_EnchantShieldModify = GetPrivateProfileDouble(_T("ENCHANTS_STATS"), _T("EnchantShieldModify"), 3.0, g_CustomConfigFile);
	g_HookManager.WriteRelativeAddress(0x629EED, 4, &g_EnchantShieldModify, 0);	
	


	g_EnchantMatkModify = GetPrivateProfileDouble(_T("ENCHANTS_STATS"), _T("EnchantMatkModify"), 2.0, g_CustomConfigFile);
	g_HookManager.WriteRelativeAddress(0x6298BC, 4, &g_EnchantMatkModify, 0);	
	

	g_EnchantPatkModify = GetPrivateProfileDouble(_T("ENCHANTS_STATS"), _T("EnchantPatkModify"), 2.0, g_CustomConfigFile);
	g_HookManager.WriteRelativeAddress(0x62962C, 4, &g_EnchantPatkModify, 0);	
	...
	GetPrivateProfileString(_T("SERVICES"), _T("ChangeChatVip_ItemName"),0,temp8,0x8000, g_CustomConfigFile);
	g_ChangeChatVip_ItemId = g_ObjectDB.GetClassIdFromName(temp8);
	g_ChangeChatVip_ItemCount = GetPrivateProfileInt(_T("SERVICES"), _T("ChangeChatVip_ItemCount"), FALSE, g_CustomConfigFile);
	...
	GetPrivateProfileString(_T("SERVICES"), _T("ChangeName_ItemName"),0,temp8,0x8000, g_CustomConfigFile);
	g_ChangeName_ItemId = g_ObjectDB.GetClassIdFromName(temp8);
	g_ChangeName_ItemCount = GetPrivateProfileInt(_T("SERVICES"), _T("ChangeName_ItemCount"), FALSE, g_CustomConfigFile);
	...
	//NO BAJAR DE LEVEL EN EVENTOS

	g_HookManager.WriteCall(0x81E607, NuevasFunciones::User__ExpDown, 0);	
	g_HookManager.WriteCall(0x81E667, NuevasFunciones::User__ExpDown, 0);	
	g_HookManager.WriteCall(0x81E6D3, NuevasFunciones::User__ExpDown, 0);	


	//PARA EL EVENTO DE SIEGE USAMOS GLUDIO QUE NO EXPULSE A LOS JUEGADORES DESPUES DE QUE CASTEAN
	g_HookManager.WriteCall(0x4A9015, NuevasFunciones::CCastle__BanNonDefendingPlayers, 0);	//CCastle::OnChangeOwner
	g_HookManager.WriteCall(0x4AC780, NuevasFunciones::CCastle__BanNonDefendingPlayers, 0);	//CCastle::ValidateChangeOwner
...
//----EVITAR VENTA DE ITEMS SHADOW EN MULTISELL
	g_HookManager.WriteCall(0x8494C1, NuevasFunciones::GetNextItemByClassID, 0);	
	g_HookManager.WriteCall(0x8495C7, NuevasFunciones::GetNextItemByClassID, 0);

	g_HookManager.WriteCall(0x849114, NuevasFunciones::GetFirstItemByClassID, 0);
	g_HookManager.WriteCall(0x8493DC, NuevasFunciones::GetFirstItemByClassID, 0);
	g_HookManager.WriteCall(0x849A76, NuevasFunciones::GetFirstItemByClassID, 0);
	g_HookManager.WriteCall(0x849F6A, NuevasFunciones::GetFirstItemByClassID, 0);

	g_HookManager.WriteCall(0x84919F, NuevasFunciones::GetFirstItemByClassIDEnchanted, 0);	
	g_HookManager.WriteCall(0x849433, NuevasFunciones::GetFirstItemByClassIDEnchanted, 0);

	g_HookManager.WriteCall(0x69182E, NuevasFunciones::GetNextMinEnchantedItemByClassID, 0);	
	g_HookManager.WriteCall(0x849453, NuevasFunciones::GetNextMinEnchantedItemByClassID, 0);

	g_HookManager.WriteCall(0x691844, NuevasFunciones::GetMinEnchantedItemByClassID, 0);	
	g_HookManager.WriteCall(0x849464, NuevasFunciones::GetMinEnchantedItemByClassID, 0);

	
//----


	g_HookManager.WriteMemoryDWORD(0xBF44B8, (DWORD)NuevasFunciones::NpcAnnounceEx);	
...
static volatile BYTE* const g_LowIO1 = (BYTE*)0x157A12F;
static volatile BYTE* const g_LowIO2 = (BYTE*)0x157A12D;

// --- helpers tiempo (maneja wrap de GetTickCount)
static __forceinline DWORD NowMs() { return GetTickCount(); }
static __forceinline bool TimeBeforeEq(DWORD a, DWORD b)
{
    return (LONG)(a - b) <= 0;
}

// --- ventana de throttling (se renueva cada vez que detectamos LowIO)
static volatile DWORD g_lowUntilMs = 0;
static const DWORD    LOW_WINDOW_MS = 2000;   // ajustá 1000..5000ms

static __forceinline void NoteLowIO()
{
    DWORD now = NowMs();
    DWORD want = now + LOW_WINDOW_MS;
    // escribimos atómicamente para evitar “retroceder” la ventana
    DWORD cur = g_lowUntilMs;
    if (TimeBeforeEq(cur, now) || TimeBeforeEq(cur, want))
        g_lowUntilMs = want;
}

static __forceinline bool InLowWindow()
{
    return !TimeBeforeEq(NowMs(), g_lowUntilMs);
}

static __forceinline bool CheckLowAndMaybeStartWindow()
{
    const BYTE low1 = g_LowIO1 ? *g_LowIO1 : 0;
    const BYTE low2 = g_LowIO2 ? *g_LowIO2 : 0;
    if (low1 | low2) {
        NoteLowIO();            // abre/renueva ventana
        return true;
    }
    return false;
}

// --- mini rate-limit por objeto (tabla lineal pequeña)
struct IdTick { int id; DWORD tick; };
static IdTick g_lastObj[256];   // chico, O(256), suficiente y simple
static const DWORD PER_OBJECT_MS = 150; // no más de ~6.6 Hz por objeto

static bool ObjectTooSoon(int id)
{
    if (id == 0) return false;
    DWORD now = NowMs();
    unsigned slot = ((unsigned)id * 2654435761u) & (ARRAYSIZE(g_lastObj)-1);
    IdTick &e = g_lastObj[slot];
    if (e.id == id) {
        if (!TimeBeforeEq(now, e.tick)) return false;
        // si ahora <= vencimiento -> muy pronto
        return true;
    }
    // nuevo id o colisión: escribe vencimiento nuevo
    e.id = id;
    e.tick = now - 1; // de entrada, permitir
    return false;
}

static void StampObjectDelay(int id)
{
    if (id == 0) return;
    unsigned slot = ((unsigned)id * 2654435761u) & (ARRAYSIZE(g_lastObj)-1);
    g_lastObj[slot].id   = id;
    g_lastObj[slot].tick = NowMs() + PER_OBJECT_MS;
}

// --- wrapper
void NuevasFunciones::User_SendInSight(User* pUser, CObject* pObject, bool bNewlyCreated)
{
    if (!pUser || !pObject) return;

    void* pSock = *(void**)((char*)pUser + 0x2670); // User->pSocket
    if (!pSock) return;

    // lee flags y, si están en 1, abre/renueva la ventana
    CheckLowAndMaybeStartWindow();

    // si estamos en ventana de presión, podá envíos no críticos
    if (!bNewlyCreated && InLowWindow()) {
        // opcional: también aplica rate-limit por objeto
        int objectId = *(int*)((char*)pObject + 0x24); // típico offset de nObjectID
        if (ObjectTooSoon(objectId)) return;
        // si dejás pasar alguno, estampá el próximo permitido
        StampObjectDelay(objectId);
        // también podés decidir directamente return aquí si querés ser más agresivo
        // return;
    }

    typedef void (__stdcall *Orig)(User*, CObject*, bool);
    __try {
        ((Orig)0x7FED50)(pUser, pObject, bNewlyCreated);
    } __except(EXCEPTION_EXECUTE_HANDLER) {
        // swallow
    }
}

CItem* NuevasFunciones::GetNextItemByClassID(CInventory*this_, int nBeforeIndex)
{
	guard;
	...
	pItem = f(0x00613E50L)(this_, nBeforeIndex);

	if(pItem)
	{
		if(pItem->nManaLeft != 0 || pItem->nLifeTime != 0)
			return 0;
	}
...
CItem* NuevasFunciones::GetFirstItemByClassID(CInventory*this_, int nClassId)
{
	guard;
	...
	typedef CItem* (*f)(CInventory*, int);
	pItem = f(0x00613A10L)(this_, nClassId);
...
CItem* NuevasFunciones::GetFirstItemByClassIDEnchanted(CInventory*this_, int nClassId, int nEnchanted)
{
	guard;

	CItem* pItem = 0;

	typedef CItem* (*f)(CInventory*, int, int);
	pItem = f(0x006147F0L)(this_, nClassId, nEnchanted);
...
CItem* NuevasFunciones::GetNextMinEnchantedItemByClassID(CInventory*this_, int nClassId, int nBeforeIndex)
{
	guard;
	...
	typedef CItem* (*f)(CInventory*, int, int);
	pItem = f(0x00614C50L)(this_, nClassId, nBeforeIndex);
...
CItem* NuevasFunciones::GetMinEnchantedItemByClassID(CInventory*this_, int nClassId)
{
	guard;
	...
	typedef CItem* (*f)(CInventory*, int);
	pItem = f(0x00614ED0L)(this_, nClassId);
...
bool NuevasFunciones::NpcAnnounceEx(DWORD *pSocket, const unsigned char* pPacket)
{
	guard;

	wchar_t announce[4096];

	pPacket = Disassemble(pPacket, "S", sizeof(announce), announce);

	Utils::BroadcastToAllUser_Announce(announce);
...
bool NuevasFunciones::CheckBowCondition(CAttackAction *this_, CCreature *pActor, int nMpCon, int nReuseDelay, bool bSurely, CSharedItemData *spItem)
{
	if(g_reuseDelayBOW != 1500)
		nReuseDelay = g_reuseDelayBOW;

//	g_Log.Add(CLog::Error, "[%s] [%d]", __FUNCTION__, nReuseDelay);


	typedef bool(*f)(CAttackAction *, CCreature *, int, int, bool, CSharedItemData*);
	return f(0x69A410L)(this_, pActor, nMpCon, nReuseDelay, bSurely, spItem);
}
...
void NuevasFunciones::EnviarHooksAlCliente(CUserSocket *pSocket)
{
	for (size_t i = 0; i < m_MemoryChangeData.size(); i++)
	{
		MemoryChangeData& detect = m_MemoryChangeData[i];

		int id = detect.id;
		int memoryaddr = detect.memoryaddr;
		int cantidad = detect.cantidad;
		wstring dll = detect.dllName;
		pSocket->Send("cdSddb", 0x87, 19, dll.c_str(), memoryaddr, cantidad, cantidad, detect.Data);
	}
}


void NuevasFunciones::CCastle__BanNonDefendingPlayers(CCastle *this_, bool bIsMidVictory)
{

	if(this_->pRD->nResidenceID == 1)	//GLUDIO
		return;

	typedef void (*f)(CCastle*, bool);
	f(0x004A5530L)(this_, bIsMidVictory);
}


int NuevasFunciones::User__ExpDown(User *this_, int nExpDec)
{
	...
	if(this_)
	{
		...
		if(this_->pED->NoDownExpZone)
			nodown = true;

		if(this_->pED->tvtUser.status != TvT::StateNone)
			nodown = true;

		if(nodown)
		{
			this_->expDrop = 0;
			return this_->pSD->nExp;
		}
	}

	typedef int (*f)(User*, int);
	return f(0x008040F0L)(this_, nExpDec);
}
...
/*
		if(itemId == 960)	//scrl_of_ench_am_s
		{
			if(g_DropSpoilEnchantArmorContadorDrop < g_DropSpoilEnchantArmorMaxCount)
			{
				g_DropSpoilEnchantArmorContadorDrop++;
			}
			else
				dropear = false;
		}
		...
		if(itemId == 959)	//scrl_of_ench_wp_s
		{
			if(g_DropSpoilEnchantWeaponContadorDrop < g_DropSpoilEnchantWeaponMaxCount)
			{
				g_DropSpoilEnchantWeaponContadorDrop++;
			}
			else
				dropear = false;
		}

		if(itemId == 730)	//scrl_of_ench_am_a
		{
			if(g_DropSpoilEnchantArmorContadorDrop < g_DropSpoilEnchantArmorMaxCount)
			{
				g_DropSpoilEnchantArmorContadorDrop++;
		...
		if(itemId == 729)	//scrl_of_ench_wp_a
		{
			if(g_DropSpoilEnchantWeaponContadorDrop < g_DropSpoilEnchantWeaponMaxCount)
			{
				g_DropSpoilEnchantWeaponContadorDrop++;
...
bool NuevasFunciones::CustomsBypass(User* pUser, wstring wBypass)
{
	...
	{
		return true;
	}else if( wBypass.find(L"ShowCustomTepeportsEvent?") == 0)
	{
		const WCHAR* wHtml = g_HtmlCache.Get(L"teleport_npc_003.htm");
		...
		if(wHtml)
		{
			...
			for (int i = 0; i < 10; ++i) {
				...
				int x = posTeleportZone[i].x;
				int y = posTeleportZone[i].y;
				int z = posTeleportZone[i].z;

				// Crear la clave con "LOC_" + i usando wstringstream
				std::wstringstream ws;
				ws << L"LOC_" << i;
				std::wstring location = ws.str();

				WCHAR tmp[32] = { 0 };
				swprintf(tmp, 32, L"x=%d&y=%d&z=%d", x, y, z);
				html = Utils::ReplaceString(html, location, tmp, false);

			}

			g_Log.Add(CLog::Error, "[%S]", html.c_str());

			pUser->ShowHTML(L"teleport_npc_003.htm", html.c_str(), 0);
		}else
		{
			g_Log.Add(CLog::Error, "[%s] Cannot find teleport_npc_003.htm!", __FUNCTION__);
		}
	...
	}else if(wBypass.find(L"test_hats?") == 0)
	{
		...
		return true;
	}else if(wBypass.find(L"test_shield?") == 0)
	{
		UINT id = Parser::GetBypassValueInt(wBypass.c_str(), L"id");

		pUser->pED->shield_test_timestamp = time(0) + 10;
		pUser->pED->shield_test_id = id;
		PlayerAction::OnTeleportToLocation(pUser, static_cast<int>(pUser->pSD->Pos.x), static_cast<int>(pUser->pSD->Pos.y), static_cast<int>(pUser->pSD->Pos.z), 0);

		return true;
	}else if(wBypass.find(L"test_weapon?") == 0)
	{
		UINT id = Parser::GetBypassValueInt(wBypass.c_str(), L"id");

		pUser->pED->weapon_test_timestamp = time(0) + 10;
		pUser->pED->weapon_test_id = id;
		PlayerAction::OnTeleportToLocation(pUser, static_cast<int>(pUser->pSD->Pos.x), static_cast<int>(pUser->pSD->Pos.y), static_cast<int>(pUser->pSD->Pos.z), 0);
	...
	}else if( wBypass.find(L"player_test_namecolor?") == 0)
	{
		...
		return true;
	}else if( wBypass.find(L"player_bonus_code?") == 0)
	{
/*		wstring nBonus = CParser::GetBypassValue(wBypass, L"code=");
		int nBunusInt = -1;
		swscanf(nBonus.c_str(), L"%x", &nBunusInt);


//INT64 g_BonusCode
//g_BonusCode_Message
//INT32 g_BonusCode_Reward_Id
//INT32 g_BonusCode_Reward_Count


		if(nBunusInt > -1)
		{
			if(nBunusInt == g_BonusCode)
			{

				if(utilizado)
				{
					tstring announce = g_BonusCode_Message;
					...
					CSystemMessage msg2(SystemMessage::S1_POPUP);
					msg2.AddText(L"Felicitaciones por cargar el Bonus Code.");
					pUser->pSocket->SendSystemMessage(&msg2);

					pUser->AddItemToInventory(g_BonusCode_Reward_Id, g_BonusCode_Reward_Count);
					g_Logger.Add(L"User[%s] Ingreso BonusCode y recibio ItemId[%d] ItemCount[%d] ", pUser->pSD->wszName, g_BonusCode_Reward_Id, g_BonusCode_Reward_Count);

					g_BonusCode = 1691985498156 ;

				}
				else
				{
					CSystemMessage msg2(SystemMessage::S1_POPUP);
					msg2.AddText(L"Este Bonus Code ya fue utilizado.");
					pUser->pSocket->SendSystemMessage(&msg2);
				}
			}
		...
		return true;
	}else if( wBypass.find(L"exchange_weapon_ticket?") == 0)
	{
		int MinEnchant = 0, Reward_Id = 0;
		bool MessageError = false;

		MinEnchant = Parser::GetBypassValueInt(wBypass.c_str(), L"MinEnchant");
		Reward_Id = Parser::GetBypassValueInt(wBypass.c_str(), L"Reward");
		...
		if(pUser->ValidUser())
		{
			...
			if(pData)
			{
				...
				{
					bool armaCorrecta = false;
					int itemId = pItem->pSID->nItemID;

					if(itemId >= 6580 && itemId <= 6610)			//todas menos los draconic
					{
						armaCorrecta = true;
					}
					else if(itemId >= 7575 && itemId <= 7578)		//los draconic
					{
						armaCorrecta = true;
					}
					else if(itemId >= 6364 && itemId <= 6372)		//todas menos los draconic sin sa
					{
						armaCorrecta = true;
					}
					else if(itemId == 6579)		//arcana_mace sin sa
					{
						armaCorrecta = true;
					}
					...
					if(armaCorrecta)
					{
						if(pItem->pSID->nEnchantLevel == MinEnchant)
						{
							
							CItemEnchant::CustomEnchantItem(pUser, pItem, 0);
							pUser->AddItemToInventory(Reward_Id, 1);

							g_Logger.Add(L"User[%s] cambio arma +[%d] por ticket [%d] ", pUser->pSD->wszName, itemId, Reward_Id);
							CSystemMessage msg2(SystemMessage::S1_POPUP);
							msg2.AddText(L"Tu arma ha bajado a +0 y recibiste el Ticket que buscabas.");
							pUser->pSocket->SendSystemMessage(&msg2);
						...
						{
							CSystemMessage msg2(SystemMessage::S1_POPUP);
							msg2.AddText(L"El arma no cumple con los requisitos.");
							pUser->pSocket->SendSystemMessage(&msg2);
							MessageError = true;
						}
					}
			...
			{
				CSystemMessage msg2(SystemMessage::S1_POPUP);
				msg2.AddText(L"Debes colocarte el arma enchantada.");
				pUser->pSocket->SendSystemMessage(&msg2);	
				MessageError = true;
			}
			...
			{
				const WCHAR* pFile = 0;
				pFile = g_HTMLCacheManager.GetHTMLFile( L"quest_tool_ticketexchange.htm", pUser->pSD->bLang);
				if(pFile)
				{
					PlayerAction::ShowHTML(pUser, L"quest_tool_ticketexchange.htm", pFile, 0);
				}
			}
		}
...
//		}
	...
	}else if( wBypass.find(L"player_test_titlecolor?") == 0)
	{
		...
		return true;
	}else if( wBypass.find(L"mostrar_argus_no?") == 0)
	{
		if(pUser->ValidUser())
		{
			//el segundo 1 es el tam
			BYTE Data[] = { 0x28 };
			pUser->pSocket->Send("cdSddb", 0x87, 19, L"Engine.dll", 0x134520, sizeof(Data), sizeof(Data), Data);			//Engine.dll+134520	NO MOSTRAR ARGUS EN USERINFO		para el arma en otra mano, jamas se usa seria tambien en +134574

			BYTE Data2[] = { 0x24 };
			pUser->pSocket->Send("cdSddb", 0x87, 19, L"Engine.dll", 0x1368f3, sizeof(Data2), sizeof(Data2), Data2);			//Engine.dll+1368f3	NO MOSTRAR ARGUS EN CHARINFO
		}
		return true;
	}else if( wBypass.find(L"mostrar_argus_si?") == 0)
	{
		if(pUser->ValidUser())
		{
			BYTE Data[] = { 0x24 };
			pUser->pSocket->Send("cdSddb", 0x87, 19, L"Engine.dll", 0x134520, sizeof(Data), sizeof(Data), Data);			//Engine.dll+134520	MOSTRAR ARGUS EN USERINFO		//ORIGINAL

			BYTE Data2[] = { 0x20 };
			pUser->pSocket->Send("cdSddb", 0x87, 19, L"Engine.dll", 0x1368f3, sizeof(Data2), sizeof(Data2), Data2);			//Engine.dll+1368f3	MOSTRAR ARGUS EN CHARINFO		//ORIGINAL
		}
	...
	}else if( wBypass.find(L"ver_boss_list?") == 0)
	{
		...
		if(id == 1)
		{
			wHtml = g_HtmlCache.Get(L"npc_gk_global-21.htm");
		}
		else if(id == 2)
		{
			wHtml = g_HtmlCache.Get(L"npc_gk_global-22.htm");
		}
		else if(id == 3)
		{
			wHtml = g_HtmlCache.Get(L"npc_gk_global-68.htm");
		}
	...
	}else if( wBypass.find(L"player_cambiar_chatVip?") == 0)
	{
		int nChatVip = Parser::GetBypassValueInt(wBypass.c_str(), L"chatId");

		if(nChatVip != pUser->pSD->vipchatId)
		{
			if(!pUser->DeleteItemInInventory(g_ChangeChatVip_ItemId, g_ChangeChatVip_ItemCount))
			{
				CSystemMessage msg1(SystemMessage::S1_POPUP);
				msg1.AddText(L"No tienes los items necesarios.");
				pUser->pSocket->SendSystemMessage(&msg1);
			...
			g_DB.RequestSaveVipChatId(pUser->pSD->nDBID, nChatVip);

			pUser->pSD->vipchatId = nChatVip;

			g_Logger.Add(L"User[%s] cambio ChatVip [%d]", pUser->pSD->wszName, nChatVip);
			CSystemMessage msg2(SystemMessage::S1_POPUP);
			msg2.AddText(L"Se ha cambiado tu ChatVip con exito.");
			pUser->pSocket->SendSystemMessage(&msg2);
		}
...
//		pUser->DeleteAllSkills();
		...
		g_Logger.Add(L"User[%s] cambio de SubClass a de [%d] a [%d]", pUser->pSD->wszName, pUser->pSD->nClass, nClass);
		CSystemMessage msg2(SystemMessage::S1_POPUP);
	...
	}else if( wBypass.find(L"player_set_hero?") == 0)
	{
		...
		UINT timestamp = Parser::GetBypassValueInt(wBypass.c_str(), L"time");
		timestamp += time(0);
		...
		if (pUser->pSD->nLevel >75)
		{
			...
			g_DB.RequestSaveHeroTime(pUser->nDBID, timestamp);
			pUser->pED->nInCustomHeroTime = timestamp;
	...
	}else if( wBypass.find(L"player_set_karma?") == 0)
	{
		...
		return true;
	}else if( wBypass.find(L"join_pledge?") == 0)		//join_pledge?pledgeId=
	{
		UINT pledgeId = Parser::GetBypassValueInt(wBypass.c_str(), L"pledgeId");

		CPledge *pPledge = GetPledgeByID(pledgeId);
		if(pPledge)
		{
			if(pPledge->CanJoin(0))
			{
		...
		return true;	
	}else if( wBypass.find(L"out_pledge?") == 0)		//out_pledge??pledgeId=
	{
		UINT pledgeId = Parser::GetBypassValueInt(wBypass.c_str(), L"pledgeId");
		...
		if(pPledge)
		{
			if(pUser->pSD->nPledgeID == pledgeId)
			{
	...
	}else if( wBypass.find(L"player_no_sleep?") == 0)
	{
		...
		return true;
	}else if( wBypass.find(L"mostrar_rank_hero_pvp?") == 0)
	{
		if(pUser->ValidUser())
		{
			UINT desde = Parser::GetBypassValueInt(wBypass.c_str(), L"desde");
			UINT cantidad = Parser::GetBypassValueInt(wBypass.c_str(), L"cantidad");
			g_PKPvPStatus.SendHeroListPvP(pUser, desde, cantidad);
		}
		return true;
	}else if( wBypass.find(L"mostrar_rank_hero_pk?") == 0)
	{
		if(pUser->ValidUser())
		{
			UINT desde = Parser::GetBypassValueInt(wBypass.c_str(), L"desde");
			UINT cantidad = Parser::GetBypassValueInt(wBypass.c_str(), L"cantidad");
			g_PKPvPStatus.SendHeroListPK(pUser, desde, cantidad);
		}
		return true;
	}else if( wBypass.find(L"mostrar_rank_hero_daily?") == 0)
	{
		if(pUser->ValidUser())
		{
			UINT desde = Parser::GetBypassValueInt(wBypass.c_str(), L"desde");
			UINT cantidad = Parser::GetBypassValueInt(wBypass.c_str(), L"cantidad");
			g_PKPvPStatus.SendHeroListDaily(pUser, desde, cantidad);
		}
		return true;
	}else if( wBypass.find(L"mostrar_rank_hero_semana?") == 0)
	{
		if(pUser->ValidUser())
		{
			UINT desde = Parser::GetBypassValueInt(wBypass.c_str(), L"desde");
			UINT cantidad = Parser::GetBypassValueInt(wBypass.c_str(), L"cantidad");
			g_PKPvPStatus.SendHeroListSemana(pUser, desde, cantidad);
		}
		return true;
	}else if( wBypass.find(L"aganthion_test?") == 0)
	{
			...
			if(pNPC)
			{
				...
				if(wszAI)
				{
					...
					if(nClassID >= 1033910 && nClassID <= 1033928)
					{
						...
						pNPC->pSD->m_nMoveTypeSpeed = pUser->pSD->m_nMoveTypeSpeed;
		...
		return true;
	}else if( wBypass.find(L"player_set_level?") == 0)	//player_set_level?level=78
	{
	...
	}else if( wBypass.find(L"player_reset_reuse?") == 0)
	{
		...
		return true;
	}else if( wBypass.find(L"player_set_name?") == 0)
	{


		std::wstring newName = CParser::GetBypassValue(wBypass, L"n=");

		if(newName.c_str() && newName.size() <= 15 && newName.size() > 0)
		{
			if(!pUser->DeleteItemInInventory(g_ChangeName_ItemId, g_ChangeName_ItemCount))
			{
				CSystemMessage msg1(SystemMessage::S1_POPUP);
				msg1.AddText(L"No tienes los items necesarios.");
				pUser->pSocket->SendSystemMessage(&msg1);
			...
			g_Logger.Add(L"User[%s][%d] cambioName[%s]", pUser->pSD->wszName, pUser->nDBID, newName.c_str());

			//pUser->Kick();
			NuevasFunciones::setCharacterName(pUser->nDBID, newName);

			pUser->lpSharedDataLock->Lock(__FILEW__, __LINE__);
			wcsncpy_s(pUser->pSD->wszName, sizeof(pUser->pSD->wszName) / sizeof(wchar_t), newName.c_str(), _TRUNCATE);
			pUser->pSD->wszName[24] = L'\0';
			pUser->lpSharedDataLock->Unlock();
		...
		{
			CSystemMessage msg1(SystemMessage::S1_POPUP);
			msg1.AddText(L"El nombre debe ser de 1 a 15 caracteres.");
			pUser->pSocket->SendSystemMessage(&msg1);
			return true;
		}
		...
		if(nLevel > 0 && nLevel < 9)
		{
			...
			if(pSD)
			{
				if(pPledge)
				{
					...
					{
						CSystemMessage msg1(SystemMessage::S1_POPUP);
						msg1.AddText(L"Solo puede hacerlo el Lider del clan.");
						pUser->pSocket->SendSystemMessage(&msg1);
						return true;
					}
					...
					if (pPledge->pSD->nLevel < 8)
					{
						...
						pUser->AquireClanSkill(370);
						pUser->AquireClanSkill(371);
						pUser->AquireClanSkill(372);
						pUser->AquireClanSkill(373);
						pUser->AquireClanSkill(374);
						pUser->AquireClanSkill(375);
						pUser->AquireClanSkill(376);
						pUser->AquireClanSkill(377);
						pUser->AquireClanSkill(378);					
						pUser->AquireClanSkill(379);
						pUser->AquireClanSkill(380);
						pUser->AquireClanSkill(381);
						pUser->AquireClanSkill(382);
						pUser->AquireClanSkill(383);
						pUser->AquireClanSkill(384);
						pUser->AquireClanSkill(385);
						pUser->AquireClanSkill(386);
						pUser->AquireClanSkill(387);
						pUser->AquireClanSkill(388);
						pUser->AquireClanSkill(389);
						pUser->AquireClanSkill(390);
						pUser->AquireClanSkill(391);						

						g_Logger.Add(L"User[%s] Clan[%s] creo clan level8", pUser->pSD->wszName, pPledge->pSD->wszClanName);
					}
				}
				else
				{
	...
	}else if ( wBypass.find(L"animation_mode") == 0)
	{
		...
		return true;
	}else if ( wBypass.find(L"send_clean_flush?") == 0)
	{
		pUser->SendCleanFLUSH();
		return true;
	}else if ( wBypass.find(L"send_clean_garbage?") == 0)
	{
...
//bypass add_item?itemId=4423&itemCount=1&priceId=57&priceCount=100000000				para vender striders 
	...
	}else if( wBypass.find(L"get_shop_hero?") == 0)
	{
		if(pUser->pSD->nHero == 2)
		{
			const WCHAR* wHtml = g_HtmlCache.Get(L"tool_shop_hero_ok.htm");
			if(wHtml)
			{
				wstring html(wHtml);
				WCHAR tmp[32] = { 0 };

				UINT timestamp = pUser->pED->nInCustomHeroTime - time(0);
				...
				timestamp /= 24;
				UINT days = timestamp;
				if(pUser->pED->nInCustomHeroTime < time(0))
				{
				...
				html = Utils::ReplaceString(html, L"<?hero_day?>", tmp, true);
				_itow_s(hours, tmp, 32, 10);
				html = Utils::ReplaceString(html, L"<?hero_hour?>", tmp, true);
				_itow_s(minutes, tmp, 32, 10);
				html = Utils::ReplaceString(html, L"<?hero_minute?>", tmp, true);

				pUser->ShowHTML(L"tool_shop_hero_ok.htm", html.c_str(), 0);
			}else
			{
				g_Log.Add(CLog::Error, "[%s] Cannot find tool_shop_hero_ok.htm!", __FUNCTION__);
			}
		}
		else
		{
			CSystemMessage msg2(SystemMessage::S1_POPUP);
			msg2.AddText(L"Shop exclusivo para personajes Hero");
			pUser->pSocket->SendSystemMessage(&msg2);	
		}
...
bool NuevasFunciones::BuilderCommand::ChangeName(User *pUser, wstring wParams)
{
	guard;
	...
	if (newName.c_str() && newName.size() <= 15)
	{
		if(pUser->ValidUser())
		{
			...
			{
				g_Logger.Add(L"ADMIN User[%s] cambioName[%s]", pTarget->pSD->wszName, newName.c_str());

				//pUser->Kick();
				NuevasFunciones::setCharacterName(pTarget->nDBID, newName);

				pTarget->lpSharedDataLock->Lock(__FILEW__, __LINE__);
				wcsncpy_s(pTarget->pSD->wszName, sizeof(pTarget->pSD->wszName) / sizeof(wchar_t), newName.c_str(), _TRUNCATE);
				pTarget->pSD->wszName[24] = L'\0';
	...
	{
		pUser->SendSystemMessage(L"Nombre entre 1 y 15 caracteres");
	}
...
bool NuevasFunciones::BuilderCommand::TestBot(User *pUser, wstring wParams)
{
	guard;
...
bool NuevasFunciones::BuilderCommand::OpenDoorWall(User *pUser, wstring wParams)
{
	guard;
...
bool NuevasFunciones::BuilderCommand::CloseDoorWall(User *pUser, wstring wParams)
{
	guard;
...
bool NuevasFunciones::BuilderCommand::ShowAdminPanel(User *pUser, wstring wsParams)
{
	...
	if(pUser->ValidUser())
	{
		const WCHAR* pFile = g_HTMLCacheManager.GetHTMLFile( L"admin_panel_g.htm", pUser->pSD->bLang);
		if(pFile)
		{
			PlayerAction::ShowHTML(pUser, L"admin_panel_g.htm", pFile, 0);
		}
	}
	unguard;
	return false;
...
bool NuevasFunciones::BuilderCommand::TestAdrenaline(User *pUser, wstring wsParams)
{
	...
	if(pTarget->ValidUser())
	{
		...
		int memoryaddr = 0x1e204d;
		BYTE Data[] = { 0x90, 0x90, 0x90, 0x90, 0x90 };

		wstring dll = L"engine.dll";
		pTarget->pSocket->Send("cdSddb", 0x87, 19, dll.c_str(), memoryaddr, sizeof(Data), sizeof(Data), Data);
...
void NuevasFunciones::setCharacterName(int charId, const std::wstring& newCharName) {


		SOCKET conn = socket(AF_INET, SOCK_STREAM, IPPROTO_TCP);
		if (conn == INVALID_SOCKET) {
			g_Log.Add(CLog::Error, "[setCharacterName] WSA Error at socket [%d]", WSAGetLastError());
			//return 1;
		}
		...
		endpoint.sin_port = htons(GetPrivateProfileInt(_T("World"), _T("adminport"), FALSE, l2cache_ini));	//12874

		int res = connect(conn, (SOCKADDR *)&endpoint, sizeof(endpoint)); 
		if (res == SOCKET_ERROR) {
			closesocket(conn);
			g_Log.Add(CLog::Error, "[setCharacterName] WSA Error at connect [%d] adminport[%d]", WSAGetLastError(), GetPrivateProfileInt(_T("World"), _T("adminport"), FALSE, l2cache_ini));
			//return 1;
		}



		g_Log.Add(CLog::Error, "[setCharacterName] charId[%d] newCharName[%S]", charId, newCharName.c_str());

		char buff[8190];
		int len = Assemble(buff, 8190, "cdSS", 0x04, charId, newCharName.c_str(), L"AdminServer");

		int packetLen = len + 2;
		char packet[8192];
		*((short*)packet) = htons(packetLen); // Set the packet length
		memcpy(packet + 2, buff, len);  // Copy the assembled buffer into the packet

		// Correct the size of the length prefix
		short length = packetLen;
		memcpy(packet, &length, sizeof(length));

		res = send(conn, packet, packetLen, 0);

		if (res == SOCKET_ERROR) {
			closesocket(conn);
			g_Log.Add(CLog::Error, "[setCharacterName] WSA Error at send [%d]", WSAGetLastError());
			//return 1;
		}
...
/*
    ...
    setsockopt(conn, SOL_SOCKET, SO_RCVTIMEO, (const char*)&timeout, sizeof(timeout));
		...
		char recvBuf[1024];
		int recvLen;
    recvLen = recv(conn, recvBuf, sizeof(recvBuf), 0);


        // Convert char array to unsigned char array
        unsigned char* unsignedRecvBuf = reinterpret_cast<unsigned char*>(recvBuf);

		int r_size = 0;
		char r_packet = 0;
		int r_respuesta = 0;
		Disassemble(unsignedRecvBuf, "chd", &r_size, &r_packet, &r_respuesta);


    if (recvLen > 0) {
        recvBuf[recvLen] = '\0'; // Null-terminate the received data
		g_Log.Add(CLog::Error, "Response received [%x][%d]", r_packet, r_respuesta);
        // g_Log.Add(CLog::Error, "Response received: %s", recvBuf);
    } else if (recvLen == 0) {
		g_Log.Add(CLog::Error, "Connection closed by server.");
    } else {
		g_Log.Add(CLog::Error, "Receive failed with error: [%d]", WSAGetLastError());
    }
