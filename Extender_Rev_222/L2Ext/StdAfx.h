...
#pragma warning(disable: 4748) //Under Test?
#pragma warning(disable: 4267) //Under Test?
...
extern TCHAR l2server_ini[260];
extern TCHAR l2cache_ini[260];
extern TCHAR g_CustomConfigFile[260];
extern TCHAR  m_ConfigsIlExt[260];

//comment it if you dont want to use it
#define EXTEND_IOBUFFER 1

//comment for interlude
//#define CHANGE_OPCODES 1
