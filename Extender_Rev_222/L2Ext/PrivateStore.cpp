...
CInventory g_CInventory;

extern int g_PrivateStore_ItemId;
...
void CPrivateStoreSystem::LoadINI()
{
	...
	g_HookManager.WriteCall( 0x82086F, g_CInventory.GetAdenaCustomAmount);	//User::SendPrivateStoreBuyManageList
	g_HookManager.WriteCall( 0x82155D, g_CInventory.GetAdenaCustomAmount);	//User::SendPackageSendableList
	g_HookManager.WriteCall( 0x82A7BB, g_CInventory.GetAdenaCustomAmount);	//User::SendPrivateStoreManageList
	g_HookManager.WriteCall( 0x82F4CC, g_CInventory.GetAdenaCustomAmount);	//User::PrivateStoreListReq
	g_HookManager.WriteCall( 0x830298, g_CInventory.GetAdenaCustomAmount);	//User::PrivateStoreBuyListReq
	g_HookManager.WriteCall( 0x830F9D, g_CInventory.GetAdenaCustomAmount);	//User::PrivateStoreListReq
	g_HookManager.WriteCall( 0x83A280, g_CInventory.GetAdenaCustomAmount);	//User::SetPrivateStoreBuyList
	g_HookManager.WriteCall( 0x83E738, g_CInventory.GetAdenaCustomAmount);	//User::PrivateStoreBuyBuy
	g_HookManager.WriteCall( 0x83F124, g_CInventory.GetAdenaCustomAmount);	//User::PrivateStoreBuyBuy
	g_HookManager.WriteCall( 0x847BBD, g_CInventory.GetAdenaCustomAmount);	//User::PrivateStoreBuy
	g_HookManager.WriteCall( 0x847F49, g_CInventory.GetAdenaCustomAmount);	//User::PrivateStoreBuy
...
bool CPrivateStoreSystem::IsValidStoreItem(int itemId, int price, int amount, UINT& error)
{
	...
	if (itemId == g_PrivateStore_ItemId)
	{
		error = 2;
	}
