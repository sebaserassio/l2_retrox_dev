...
void CRebirthSystem::OnResetSubClass(User *pUser)
{
	guard;
	...
	if(m_Enabled)
	{
		...
		int total = ru.bonusInt + ru.bonusStr + ru.bonusCon + ru.bonusMen + ru.bonusDex + ru.bonusWit;

		ru.availablePoints = ru.availablePoints + total;
