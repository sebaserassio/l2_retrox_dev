...
struct MembersLimit
{
	...
	MembersLimit() : MainClan0(10), MainClan1(15), MainClan2(20), MainClan3(30), MainClan4(40), MainClan5(40), MainClan6(50), Academy(20), RoyalGuard(20), OrderOfKnight(10) {}
};
...
typedef vector<CPledge *> MemberDataAllyMap;
...
public:
	...
	/* 00A0 */ int _unk00A0;
	/* 00A4 */ int _unk00A4;
	/* 00A8 */ int m_nAllianceDismissTime;
	/* 00AC */ int m_nAllianceOustedTime;
	/* 00B0 */ int m_nAllianceWithdrawTime;
	/* 00B4 */ int _unk00B4;
	/* 00B8 */ int _unk00B8;
	/* 00BC */ int _unk00BC;
	/* 00C0 */ int _unk00C0;
...
public:
	...
	INT64 *GetAlliance();
	int GetAllianceID();
	int GetAllianceCounts();
	//void GetAllMemberAlliancePledge(MemberDataAllyMap& lista);
	MemberDataAllyMap GetAllMemberAlliancePledge();

	PWCHAR GetAllianceName();
	int GetAllianceCrestID();
	int GetAllianceMasterPledgeID();
