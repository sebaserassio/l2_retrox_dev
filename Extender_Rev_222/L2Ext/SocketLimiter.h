...
public:
	...
	static int FastTCPTransfer(SOCKET pSocket, int Level, int optname, const char* optval, int optlen);


	static void UserSocketBadunknownprotocol(CLog * pInstance, UINT severity, const char *format, ...);
};
