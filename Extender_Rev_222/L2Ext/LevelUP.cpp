...
extern double g_KarmaRateDownExpInc;
extern double g_KarmaRateDownDie;

extern double g_KarmaRateDownExpInc78;
extern double g_KarmaRateDownDie78;
...
//	g_HookManager.WriteJump( 0x7FF550, (INT32)LevelUpSystemFixHook1, 0);
	g_HookManager.WriteCall(0x7FF561, CL2LevelUP::CPCParamDB_GetKarmaIncreaseAmount, 0);	//ExpInc
	g_HookManager.WriteCall(0x81E987, CL2LevelUP::CPCParamDB_GetKarmaIncreaseAmount_Die, 0);	//Die
...
//	g_Log.Add(CLog::Error, "CPCParamDB_GetKarmaIncreaseAmount 1111[%f]", ret);


	if(Level >= 78)
	{
		ret /= 64;		//divide by 64
		ret *= g_KarmaRateDownExpInc78;
	}
	else
	{
		ret *= g_KarmaRateDownExpInc;
	}

//	g_Log.Add(CLog::Error, "CPCParamDB_GetKarmaIncreaseAmount 2222[%f]", ret);

	return ret;
}

double CL2LevelUP::CPCParamDB_GetKarmaIncreaseAmount_Die(LPVOID pInstance, int Level)
{
	typedef double (*f)(LPVOID, int);
	double ret = f(0x745770L)(pInstance, Level);
	...
	{
		ret /= 64;		//divide by 64
		ret *= g_KarmaRateDownDie78;
	}
	else
	{
		ret *= g_KarmaRateDownDie;
	}
