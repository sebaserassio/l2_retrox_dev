...
public:
	...
	static const Native MoveToTarget = 0x006A9D00L;
	...
	void AddExecutable2(MemoryObject* Matrix, Native Func, CExecutionArgumentMoveToTarget* Arg)
	{
		typedef void (*f)(CAsynchronousExecution*, MemoryObject*, Native, CExecutionArgumentMoveToTarget*);
		f(0x444050L)(this, Matrix, Func, Arg);
	};
};