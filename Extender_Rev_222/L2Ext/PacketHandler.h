...
public:
	...
	static bool ReceiveData(CUserSocket *pSocket, char* pPacket, INT16 nPacketLen, BYTE nPacketID);
};
...
static bool RequestJoinAlly(CUserSocket *pSocket, const unsigned char* packet);
...
static bool RequestPrivateStoreBuyManageList(CUserSocket *pSocket, const unsigned char* packet);
static bool PrivateStoreBuyListSet(CUserSocket *pSocket, const unsigned char* packet);
static bool RequestPrivateStoreSellManageList(CUserSocket *pSocket, const unsigned char* packet);
...
static bool RequestRecipeShopManageList(CUserSocket *pSocket, const unsigned char* packet);
...
static bool ShowCommunityBoard(CUserSocket *pSocket, const unsigned char *packet);
static bool PrivateStoreSellMsg(CUserSocket *pSocket, const unsigned char* packet);
static bool PrivateStoreBuyMsg(CUserSocket *pSocket, const unsigned char* packet);
static bool RequestRecipeShopSetMsg(CUserSocket *pSocket, const unsigned char* packet);
static bool VoteSociality(CUserSocket *pSocket, const unsigned char* packet);
